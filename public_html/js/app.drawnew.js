/**
 * Application: ApplicationDrawNew
 *
 * @package ajwm.Applications
 * @author Anders Evenrud <andersevenrud@gmail.com>
 * @class
 */
var ApplicationDrawNew = (function($, undefined) {
  return function(Application, app, api, argv) {
    var _ApplicationDrawNew = Application.extend({


      // !!! DO NOT TOUCH

      init : function() {
        this._super("ApplicationDrawNew");
      },
      ...
      EventToggleStroke : function(ev) {

      },


      EventToggleFill : function(ev) {

      },


      EventChangeBackground : function(ev) {

      },


      EventChangeForeground : function(ev) {
      ...
      run : function() {
        ...
        el.find(".toolbutton_stroke").bind("click", function(ev) {
          self.EventToggleStroke(ev);
        });

        el.find(".toolbutton_fill").bind("click", function(ev) {
          self.EventToggleFill(ev);
        });

        el.find(".colorbutton_background").bind("click", function(ev) {
          self.EventChangeBackground(ev);
        });

        el.find(".colorbutton_foreground").bind("click", function(ev) {
          self.EventChangeForeground(ev);
        });
    ...
    var __ApplicationDrawNew = _ApplicationDrawNew.extend({
      ...
      EventChangeBackground : function(ev) {
        api.system.dialog_color(Style.fill.hex, function(rgb, hex) {
          $(el).find(".colorbutton_background").css("background-color", hex);
      ...
      EventChangeForeground : function(ev) {
        api.system.dialog_color(Style.stroke.hex, function(rgb, hex) {
          $(el).find(".colorbutton_foreground").css("background-color", hex);
      ...
      run : function() {
        ...
        Tool.fill    = $(el).find(".toolbutton_fill button").hasClass("Checked");
        Tool.stroke  = $(el).find(".toolbutton_stroke button").hasClass("Checked");
    ...
    return new __ApplicationDrawNew();
  };
})($);
