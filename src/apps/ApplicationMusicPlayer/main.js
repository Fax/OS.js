    ...
    var Window_window1 = GtkWindow.extend({
      ...
      create : function(id, mcallback) {
        ...
        if ( el ) {
          ...
          el.find(".menuitem_file").click(function(ev) {
